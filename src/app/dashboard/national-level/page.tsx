...
const NationalOfficerDashboard = () => {
    ...
    useEffect(() => {
        trackPageView('/dashboard/national-level', 'National Level Dashboard');
    }, [trackPageView]);
        ...
        <div className="min-h-screen p-6 space-y-6">
            <div className="mb-6">
                <h1 className={`text-3xl font-bold ${theme === 'dark' ? 'text-white' : 'text-gray-900'}`}>
                    {t('dashboard.nationalOfficerDashboard')}
                </h1>
            ...
            <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
                {beneficiaryData && (
                    <BeneficiaryCountTable
                        ...
                        title={t('dashboard.beneficiaryCountByYear')}
                ...
                {beneficiaryTypeData && (
                    <BeneficiaryTypeTable
                        ...
                        title={t('dashboard.beneficiaryCountByType')}
                        locationDisplayName={locationName}
                        isLoading={isLoading}
                    />
                )}
                ...
                {empowermentData && (
                    <EmpowermentDimensionTable
                        ...
                        title={t('dashboard.nationalEmpowermentDimensionCounts')}
                        locationDisplayName={locationName}
                        isLoading={isLoading}
                    />
                )}
