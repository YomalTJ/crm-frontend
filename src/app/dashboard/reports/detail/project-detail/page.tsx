...
const ProjectDetailReport = () => {
    ...
    return (
        <div className={`p-6 min-h-screen ${getBgColor()}`}>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4">
                        <div className="flex-1">
                            <input
                                ...
                                className={`w-full px-4 py-2 border-wh rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 ${getBorderColor()
                                    } ${getInputBgColor()}`}
                            />
                        </div>
                        <select
                            ...
                            className={`px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 ${getBorderColor()
                                } ${getInputBgColor()}`}
                        >
