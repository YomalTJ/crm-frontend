    ...
    <div className="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] sm:p-6">
      <div className="flex justify-between">
        <div>
          ...
          <p className="mt-1 text-gray-500 text-theme-sm dark:text-gray-400">
            Number of Samurdhi beneficiaries by district
          </p>
        </div>
      ...
      <div className="space-y-5">
        <BeneficiaryDistrict
          ...
          beneficiaries={2379}
          percentage={79}
          flagSrc="/images/Flag_of_Sri_Lanka.svg.png"
        />
        <BeneficiaryDistrict
          district="Kandy"
          beneficiaries={589}
...
// Extracted small component for district beneficiary info
function BeneficiaryDistrict({
  district,
  beneficiaries,
  percentage,
  flagSrc,
    ...
    <div className="flex items-center justify-between">
      <div className="flex items-center gap-3">
        <div className="items-center w-full rounded-full max-w-8">
          <Image width={48} height={48} src={flagSrc} alt={district} className="w-full" />
        </div>
        <div>
      ...
      <div className="flex w-full max-w-[140px] items-center gap-3">
        <div className="relative block h-2 w-full max-w-[100px] rounded-sm bg-gray-200 dark:bg-gray-800">
          <div
            className="absolute left-0 top-0 flex h-full items-center justify-center rounded-sm bg-success-600 text-xs font-medium text-white"
